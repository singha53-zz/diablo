...
## load data
load("~/Dropbox/Manuscript/diablo_datasets/brca/trainTestDatasetsNormalized.RDATA")
```
...
tune <- readRDS("~/Dropbox/Manuscript/diablo_datasets/brca/brcaPanel_tune.rds")
```
...
driverdbv2 <- read.delim(paste0(WhereAmI, "results/disease_collections/driverdbv2.txt"), header = FALSE) %>% 
  as.matrix %>% 
  as.character()

mircancer <- read.delim(paste0(WhereAmI, "results/disease_collections/miRCancerOctober2017.txt"), header = FALSE)
...
omim0 <- read.delim(paste0(WhereAmI, "results/disease_collections/OMIM_Disease.txt"), header = FALSE)
...
pdf(paste0(WhereAmI, "results/Figures/brcaPanel_features.pdf"), width = 10, height=13)
